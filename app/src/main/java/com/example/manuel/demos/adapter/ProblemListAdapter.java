...
public class ProblemListAdapter extends BaseAdapter {
    ...
    private ArrayList<Boulder> mDataSource;

    public ProblemListAdapter(Context context, ArrayList<Boulder> items) {
        mContext = context;
        mDataSource = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = mInflater.inflate(R.layout.list_item_problem, parent, false);
        ...
        Boulder recipe = (Boulder) getItem(position);
